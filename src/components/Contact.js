...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_zg8dxlw', 'template_s5h2goa', templateParams, 'tTP0hKUuOjPJpSw_i')
      .then((response) => {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='input-box'>
          <input
            ...
            style={{ WebkitAppearance: 'textfield', MozAppearance: 'textfield', appearance: 'textfield', ...inputStyle }}
          />
        ...
        <div style={{
          marginTop:'2rem',
          color:color === 'green'?'RGB(0, 100, 0)':'red',
          fontSize:'2rem'
        }}>{emailSentResult}</div>
      </form>
    </div>
